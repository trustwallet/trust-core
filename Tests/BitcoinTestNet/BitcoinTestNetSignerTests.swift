...
class BitcoinTestNetSignerTest: XCTestCase {
    ...
    func test_P2WSH_in_P2SH_Sig() {
        ...
        let toAddress =  BitcoinTestNetSegwitAddress(string: "tb1qh5l85fp6938unyuk7qhtk452z2lqenm2289l8g")!
    ...
    func testSignTransactionTry() {
        do {
            try testSignTransaction()
        } catch let error  {
            print(error)
        }
    }
    
    func testCommonSignTransactionTry() {
        do {
            try testCommonSignTransaction()
    ...
    func testSegWitTransactionTry() {
        do {
            try testSegWitTransaction()
    ...
    func testSegWitTransaction() throws {
        let toAddress = BitcoinAddress(string: "2NFU79Kzp4NV6YzZgei7MpMYJC2CamRgXHn")!
        let changeAddress = BitcoinTestNetSegwitAddress(string: "tb1qyhkw8rzzpwap78625yjkqzcpl2djdafucjcga7")!
