...
class ENSEncoderTests: XCTestCase {
    ...
    func testEncodeOwner() {
        ...
        let result = ENSEncoder.encodeOwner(node: node.namehash)
    ...
    func testEncodeSetOwner() {
        ...
        let result = ENSEncoder.encodeSetOwner(node: node.namehash, owner: address)
    ...
    func testEncodeResolver() {
        ...
        let result = ENSEncoder.encodeResolver(node: node.namehash)
    ...
    func testEncodeSetResolver() {
        ...
        let result = ENSEncoder.encodeSetResolver(node: node.namehash, resolver: address)
    ...
    func testEncodeSetSubnodeOwner() {
        ...
        let result = ENSEncoder.encodeSetSubnodeOwner(node: node.namehash, label: label.labelhash, owner: address)
    ...
    func testEncodeTTL() {
        ...
        let result = ENSEncoder.encodeTTL(node: node.namehash)
    ...
    func testEncodeSetTTL() {
        ...
        let result = ENSEncoder.encodeSetTTL(node: node.namehash, ttl: ttl)
