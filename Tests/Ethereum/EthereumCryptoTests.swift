...
class EthereumCryptoTests: XCTestCase {
    func testSign() {
        ...
        XCTAssertTrue(EthereumCrypto.verify(signature: signature, message: hash, publicKey: publicKey))
    }

    func testGetPublicKey() {
        let privateKey = Data(hexString: "7a28b5ba57c53603b0b07b56bba752f7784bf506fa95edc395f5cf6c7514fe9d")!
        XCTAssertEqual(EthereumCrypto.getPublicKey(from: privateKey).hexString, "0432d87c5cd4b31d81c5b010af42a2e413af253dc3a91bd3d53c6b2c45291c3de71633bf7793447a0d3ddde601f8d21668fca5b33324f14ebe7516eab0da8bab8f")
    }
}
